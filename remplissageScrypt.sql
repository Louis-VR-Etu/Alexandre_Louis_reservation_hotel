...
INSERT INTO customer(mail,name,surname,birthDate,phoneNumber) values ('etu39998@henallux.be', 'De Jonge', 'Alexandre',str_to_date('1/04/2000','%d/%m/%Y'),'0476037797');
...
INSERT INTO room(number,hotelName,floor,roomTypeName) values(40,'Buckingham Palace',3,'ouble Room');
